...
const cargarPosts=async()=>{
  ...
  <th scope="row">${respuesta.id}</th>
        ...
        <td><button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="bi bi-backspace m_2"></i>Eliminar</button></td>
        `
